    ...
    return (
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            {mounted ? (
                ...
                <div className="h-10 w-[200px] rounded-full border" />
            )}
            </div>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
            ...
            {products.length === 0 ? (
                ...
                <div className="text-base font-semibold">Produk tidak ditemukan</div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <Button
                                ...
                                className={cn(
                                    ...
                                    // samain persis: hijau = white text, normal = primary
                                    isAdded
